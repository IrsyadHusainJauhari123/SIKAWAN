        ...
        <div class="row">
            <div class="container">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ url('datakecamatan', $datakecamatan->id) }}" method="post"
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="judul" name="judul" placeholder="judul"
                                    value="{{ $datakecamatan->judul }}">
                            </div>

                            <div class="form-group">
                                <label for="layanan">Data file Kecamatan</label>
                                <select name="level" class="form-control"value="{{ $datakecamatan->level }}">
                                    {{-- <option>--- Level ---</option> --}}
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="deskripsi" style="width: 100%; height: 150px;">{{ $datakecamatan->deskripsi }}"</textarea>
                            </div>
                            {{-- <div class="form-group">

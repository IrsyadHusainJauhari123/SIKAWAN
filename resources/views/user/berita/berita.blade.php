    ...
    <div class="container-xxl position-relative p-0">
        ...
        <div class="container-xxl bg-primary page-header" style="background-color: #964B00"
            ...
            <div class="container text-center">
                <h1 style="font-size: 30px" style="font-family: sans-serif" class="text-white animated zoomIn mb-3">Berita
                    Update</h1><br>
                ...
                <form action="{{ url('Berita') }}" method="post">
                    ...
                    <div style="height: 100px" class="position-relative w-50 mt-">
                        <input class="form-control border-0 rounded-pill w-100 ps-4 pe-5" type="text"
                            placeholder="Cari Berita" style="height: 25px;" name="judul" id="q"
                            value="{{ $judul ?? '' }}"><br>
                                    ...
                                    <div class="card-body" style="background-color: rgb(245, 241, 241)"><br>
                                        <div class="text-overflow">
                                            ...
                                            <p style="margin-left: 5%" style="text-align: right" class="btn btn-danger">
                                                {{ $berita->created_at->isoFormat('dddd, D MMMM Y') }}</p>

                                            <a style="margin-left: 2%" href="{{ url('Berita', $berita->id) }}"
                    ...
                    {{-- <div class="card shadow border-0">
                                <a href="{{ url('Berita', $berita->id) }}">
                                    <div class="carousel-item active">
                                        <img style="width: 100%;" src="{{ "/public/$berita->foto" }}">
                                        <div class="carousel-caption d-none d-md-block"
                                            style="margin-bottom: -20px; height: 50px;">
                                            <p style="opacity: 100%">{{ $berita->created_at->diffForHumans() }}</p>
                                        </div>
                                    </div>
                                </a>
                                <div class="card-body">

        ...
        <div class="container-xxl position-relative p-0">
            ...
            <div class="container-xxl bg-primary page-header">
                <div class="container text-center">
                    <h1 class="text-white animated zoomIn mb-3">{{ $berita->judul }}</h1>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb justify-content-center">
                            <li class="breadcrumb-item"><a class="text-white" href="{{ url('Berita') }}">Berita</a></li>
                            <li class="breadcrumb-item"><a class="text-white" href="#">Pages</a></li>
                            <li class="breadcrumb-item text-white active" aria-current="page">{{ $berita->judul }}</li>
                        </ol>
                    </nav>
                </div>
            </div>
                        ...
                        <div id="slider1" class="rev_slider" data-version="5.0">
                            <ul>
                                <li data-transition="slidingoverlayleft">
                                    <img class="rsimg rsMainSlideImage" src="{{ "/public/$kegiatan->foto" }}"
                                ...
                                <li data-transition="slidingoverlayleft">
                                    ...
                                    <img src="{{ "/public/$kegiatan->foto1" }}" class="d-block w-100" alt="...">

                                <li data-transition="slidingoverlayleft">

                                    <img src="{{ "/public/$kegiatan->foto2" }}" class="d-block w-100" alt="...">
                        </div>
                    </section>
                </div>
                <div class="col-sm-6">

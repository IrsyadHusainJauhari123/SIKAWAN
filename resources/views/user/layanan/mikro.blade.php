...
<body>
        ...
        <div class="row g-5">
            <div class="col-sm-12 wow fadeIn" data-wow-delay="0.1s">
                <div class="container">
                    ...
                    <h2>Dokumen Pendukung | <strong>Pembuatan Surat Izin Usaha Mikro</strong></h2>
                    <hr>
                </div>
            </div>
        </div>
                        ...
                        <div style="padding: 30px" class="box-content">
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <h1 style="text-align: justify"> File Membuat Surat Izin Usaha Mikro Kecamatan Delta
                                        Pawan
                                    </h1>
                        ...
                        @foreach ($mikro as $mikro)
                            <div style="padding-left: 15%" class="row">
                                <div style="right: 13%" class="col-md-12"><br>
                                    <a href="{{ "/public/$mikro->file" }}" download
                                        class="btn btn-lg btn-primary mr-xs mb-lg">DOWLOAD</a>
                                    {{-- <a href="{{ "/public/$mikro->file" }}"
    ...
    <p><br>
        <center> <img style="width: 75%; height:auto;" src="{{ "/public/$mikro->foto" }}"></center>
    </p><br><br><br><br><br><br><br><br>
    {{-- <div id="carouselExampleSlidesOnly" class="carousel slide carousel-fade" data-bs-ride="carousel">
        <div class="carousel-item active">
            <img style="padding-inline: 20%" src="{{ "/public/$mikro->foto" }}" alt="Card image">
        </div>
    </div>

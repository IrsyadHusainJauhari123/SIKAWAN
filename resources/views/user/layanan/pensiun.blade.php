...
<body>
        ...
        <div class="row g-5">
            <div class="col-sm-12 wow fadeIn" data-wow-delay="0.1s">
                <div class="container">
                    ...
                    <h2>Dokumen Pendukung | <strong>Pembuatan Surat Keterangan Pensiun</strong></h2>
                    <hr>
                </div>
            </div>
        </div>
    ...
    <div style="margin-left: 17%" class="container">
                        ...
                        <div style="padding: 30px" class="box-content">
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <h1 style="text-align: justify"> File Membuat Keterangan Pensiun Kecamatan Delta
                                        Pawan
                                    </h1>
                        ...
                        @foreach ($pensiun as $pensiun)
                            <div style="padding-left: 15%" class="row">
                                <div style="right: 13%" class="col-md-12"><br>
                                    <a href="{{ "/public/$pensiun->file" }}" download
                                        class="btn btn-lg btn-primary mr-xs mb-lg">DOWLOAD</a>
                                    {{-- <a href="{{ "/public/$pensiun->file" }}"
                    ...
                    <div class="container-xxl py-2">
                        <div class="container">
                            <div class="col-lg-7">
                                {{-- <div class="row g-5">
                                    <div class="col-sm-12 wow fadeIn" data-wow-delay="0.1s">
                                        <h3 class="mb-2">{{ $pensiun->judul }}</h3>
                                        <p>{{ $pensiun->deskripsi }}</p>
                                    </div>
                                </div> --}}
                            </div>
                        </div>
    ...
    <p><br>
        <center> <img style="width: 75%; height:auto;" src="{{ "/public/$pensiun->foto" }}"></center>
    </p><br><br><br><br><br><br><br><br>
    {{-- <div id="carouselExampleSlidesOnly" class="carousel slide carousel-fade" data-bs-ride="carousel">
        <div class="carousel-item active">
            <img style="padding-inline: 20%" src="{{ "/public/$pensiun->foto" }}" alt="Card image">
        </div>
    </div>

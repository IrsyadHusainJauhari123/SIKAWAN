        ...
        <div class="container-xxl position-relative p-0">
            ...
            <div class="container-xxl bg-primary page-header">
                <div class="container text-center">
                    <h1 class="text-white animated zoomIn mb-3">{{ $kebudayaan->judul }}</h1>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb justify-content-center">
                            <li class="breadcrumb-item"><a class="text-white" href="{{ url('kebudayaan') }}">kebudayaan</a></li>
                            <li class="breadcrumb-item"><a class="text-white" href="#">Pages</a></li>
                            <li class="breadcrumb-item text-white active" aria-current="page">{{ $kebudayaan->judul }}</li>
                        </ol>
                    </nav>
                </div>
            </div>
                        ...
                        <div id="slider1" class="rev_slider" data-version="5.0">
                            <ul>
                                <li data-transition="slidingoverlayleft">
                                    <img class="rsimg rsMainSlideImage" src="{{ "/public/$kebudayaan->foto" }}"
                                ...
                                <li data-transition="slidingoverlayleft">
                                    ...
                                    <img src="{{ "/public/$kebudayaan->foto1" }}" class="d-block w-100" alt="...">
                                <li data-transition="slidingoverlayleft">
                        ...
                        <div class="col-sm-12 wow fadeIn" data-wow-delay="0.1s">
                            ...
                            <div style="margin: 14px" class="mb10 labels" dir="ltr">
                                <span style="background-color: blue" class="label label-default">
                                    <i style="margin: 5px" class="fa fa-thumb-tack">{{ $kebudayaan->tanggal }}
                                    </i>
                                </span>
                                <span style="margin: 5px" style class="label label-default" style="">
                                    <i style="margin: 2.4px" class="fa fa-user">{{ $kebudayaan->nama_pembuat }}
                                    </i>
                                </span><br>
                            </div>

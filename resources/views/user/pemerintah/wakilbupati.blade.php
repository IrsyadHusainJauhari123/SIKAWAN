    ...
    <div class="container-xxl position-relative p-0">
        ...
        <div class="container-xxl bg-primary page-header" style="background-color: #964B00"
            ...
            <div class="container text-center">
                <h1 style="font-size: 30px" style="font-family: sans-serif" class="text-white animated zoomIn mb-3">Wakil
                    Bupati</h1>
        ...
        <div class="container">
            <div class="row g-5 align-items-center">
                <div class="col-lg-12 wow zoomIn" data-wow-delay="0.1s">
                    @foreach ($wakilbupati as $wakilbupati)
                        {{-- <h2 class="mb-4" style="text-align: center">wakil_bupati Ketapang</h2><br> --}}
                        <center>
                            <img class="img-fluid w-100 mb-4" style="image-resolution: full-right"
                                src="{{ "/public/$wakilbupati->foto" }}" alt="">
                        </center><br>
                        ...
                        <table style="width: 509px; height 184px;" border="0">
                            <tbody>
                                ...
                                <td style="font-size: 20px;" style="font-family: Arial, Helvetica, sans-serif;"
                                    style="padding: 1%;" style="color: rgb(105, 98, 98)">{{ $wakilbupati->periode }}
                                </td>
                                <tr><br>
                                ...
                                <td style="font-size: 20px;" style="font-family: Arial, Helvetica, sans-serif;"
                                    ...
                                    {{ $wakilbupati->pendidikan_terakhir }}</td>
                        ...
                        <tr><br> <strong <p class="mb-4" style="color: black"
                                style="text-align: justify;">{!! nl2br($wakil_bupati->deskripsi) !!}
                                </p>
                            </strong><br> --}}
                    @endforeach
                </div>
